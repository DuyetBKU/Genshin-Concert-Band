...
<body>
    ...
    <!--Phần "Extras":
Fan Art: Bộ sưu tập các tác phẩm nghệ thuật của cộng đồng về các nhân vật trong Genshin Impact.
Cosplay: Hình ảnh hoặc video về cosplay các nhân vật trong trò chơi, có thể kèm theo hướng dẫn.
Trivia: Những thông tin thú vị, ít người biết về trò chơi, các nhân vật hoặc nhà phát triển.
Mini-Games: Liên kết hoặc nhúng các trò chơi nhỏ hoặc quiz liên quan đến Genshin Impact.
Easter Eggs: Danh sách các chi tiết ẩn thú vị trong trò chơi mà người chơi có thể không chú ý.
Phần "Media":
Music: Bộ sưu tập các bản nhạc nền trong trò chơi hoặc nhạc remix do cộng đồng sáng tạo.
Video Highlights: Các video nổi bật, trailer chính thức của game, hoặc các cảnh chơi đặc biệt từ band của bạn.
Livestreams: Lịch hoặc liên kết tới các buổi livestream về Genshin Impact.
Gallery: Bộ sưu tập ảnh về các sự kiện trong game, screenshot đẹp, hoặc artwork chính thức từ nhà phát triển.
Wallpapers: Bộ hình nền chất lượng cao từ Genshin Impact mà người hâm mộ có thể tải về.-->
    ...
    <div id="main1">
        <div id="header">
            ...
            <input type="checkbox" hidden name="" id="nav_input" class="nav_input_mobile" />

            <nav class="nav_overlay_mobile">
                <ul class="nav_mobile">
                    <label for="nav_input" class="nav_mobile_close">
                        <i class="ti-close"></i>
                    </label>
        ...
        <div id="content">
            <div id="band" class="content-section">
                ...
                <p class="about-text">
                    Welcome to Chapter of the New Era, where we celebrate the talented
                    musicians of the Genshin Impact universe! Our fictional band takes
                    inspiration from the vibrant world of Teyvat, blending captivating
                    melodies with dynamic storytelling. Each band member brings their
                    unique flair and musical style, reflecting the rich diversity of
                    Genshin’s beloved characters. From epic anthems to soulful ballads,
                    we strive to capture the essence of adventure and camaraderie.
                    Whether you're a devoted traveler or a music enthusiast, join us on
                    this creative journey, where the spirit of Genshin meets the magic
                    of music!
                </p>
                <iframe class="video" src="https://www.youtube.com/embed/3NbIcIJU2co"
                    title="Genshin Concert 2022 All Character Themes" frameborder="0"
            ...
            <div id="tour" class="tour-section">
                <div class="content-section">
                    ...
                    <p class="section-subheading text-white">
                    ...
                    <div class="row place-list">
                        <div class="col col-third">
                            <div class="place-img PicMondstadt thumbnail"></div>
                            <div class="place-body">
                                <h3 class="place-heading">Mondstadt</h3>
                                <p class="place-time">Mon 25 Nov 2019</p>
                                <p class="place-desc">
                                    The City of Freedom, celebrates music with a lively festival
                                    that you won’t want to miss!
                                </p>
                                <button class="place-buy-button js-buy-ticket">
                                    Buy Tickets
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="col col-third">
                            <div class="place-img PicLiyue"></div>
                            <div class="place-body">
                                <h3 class="place-heading">Liyue</h3>
                                <p class="place-time">Sat 28 Nov 2020</p>
                                <p class="place-desc">
                                    The City of Contracts, invites you to experience its rich
                                    cultural heritage through its symphonic melodies.
                                </p>
                                <button class="place-buy-button js-buy-ticket">
                                    Buy Tickets
                                </button>
                        ...
                        <div class="col col-third">
                            <div class="place-img PicInazuma"></div>
                            <div class="place-body">
                                <h3 class="place-heading">Inazuma</h3>
                                <p class="place-time">Fri 26 Nov 2021</p>
                                <p class="place-desc">
                                    The land of eternity, offers a musical journey that reflects
                                    its electro-powered culture.
                                </p>
                                <button class="place-buy-button js-buy-ticket">
                                    Buy Tickets
                                </button>
                        ...
                        <div class="col col-third">
                            <div class="place-img PicSumeru"></div>
                            <div class="place-body">
                                <h3 class="place-heading">Sumeru</h3>
                                <p class="place-time">Thu 24 Nov 2022</p>
                                <p class="place-desc">
                                    Home to the Akademiya, showcases musical performances that
                                    blend tradition and knowledge.
                                </p>
                                <button class="place-buy-button js-buy-ticket">
                                    Buy Tickets
                                </button>
                        ...
                        <div class="col col-third">
                            <div class="place-img PicFontaine"></div>
                            <div class="place-body">
                                <h3 class="place-heading">Fontaine</h3>
                                <p class="place-time">Wed 29 Nov 2023</p>
                                <p class="place-desc">
                                    The center of culture and art, hosts a grand musical event
                                    at the Théâtre Mechanique.
                                </p>
                                <button class="place-buy-button js-buy-ticket">
                                    Buy Tickets
                                </button>
                        ...
                        <div class="col col-third">
                            <div class="place-img PicNatlan"></div>
                            <div class="place-body">
                                <h3 class="place-heading">Natlan</h3>
                                <p class="place-time">Tue 26 Nov 2024</p>
                                <p class="place-desc">
                                    Natlan’s fiery spirit comes alive in a dynamic concert that
                                    mirrors the energy of its people.
                                </p>
                                <button class="place-buy-button js-buy-ticket">
                                    Buy Tickets
                                </button>
            ...
            <!--CHECK PHẦN THU THẬP COMMENT-->
            <div id="contact" class="content-section">
                <h2 class="section-heading">CONTACT</h2>
                <p class="section-subheading">Fan? Drop a note!</p>

                <div class="row">
                    <div class="col col-haft contact-content">
                        <p>
                            <i class="ti-location-pin"></i>Tan Phu, Ho Chi Minh, Vietnam
                        </p>
                        <p><i class="ti-mobile"></i>Phone: (+84)853251400</p>
                        <p>
                            <i class="ti-location-pin"></i>Email: duyet.cao1203@hcmut.edu.vn
                        </p>
                    </div>
                    <div class="form-content col col-half">
                        <form action="index.php" method="COMMENT">
                            <div class="row">
                                <div class="col col-half">
                                    <input type="text" placeholder="Name" required id="contact-name"
                                        class="form-control" />
                                </div>
                                <div class="col col-half">
                            ...
                            <div class="row">
                                <div class="col col-full">
                                    <input type="text" placeholder="Message" required id="contact-message"
                                        class="form-control" />
                                </div>
                            </div>
            ...
            <div id="merchandise" class="merchandise-section">
                ...
                <table class="content-section">
                    <tbody>
                        ...
                        <tr class="tr-type1"
                            onclick="window.open('https://genshin.global/product/genshin-concert-2022-harmonica-necklace/', '_blank')"
                            style="cursor: pointer">
                            <div>
                                <td>Mini harmonica necklace</td>
                                <td>US$55.99</td>
                            </div>
                        </tr>

                        <tr onclick="window.open('https://genshin.global/product/concert-2022-character-gift/', '_blank')"
                            style="cursor: pointer">
                            <td>Character mood gift box</td>
                            <td>US$55.99</td>
                        </tr>

                        <tr class="tr-type1"
                            onclick="window.open('https://genshin.global/product/genshin-concert-2022-acrylic-display/', '_blank')"
                            style="cursor: pointer">
                            <td>Acrylic ornament</td>
                            <td>US$24.99</td>
                        </tr>

                        <tr onclick="window.open('https://genshin.global/product/genshin-concert-2022-keychain/', '_blank')"
                            style="cursor: pointer">
                            <td>Acrylic hangable</td>
                            <td>US$13.99</td>
                        </tr>

                        <tr class="tr-type1"
                            onclick="window.open('https://genshin.global/product/concert-2022-postcards/', '_blank')"
                            style="cursor: pointer">
                            <td>Series postcard set</td>
                            <td>US$19.99</td>
                        </tr>

                        <tr onclick="window.open('https://genshin.global/product/genshin-concert-2022-badge/', '_blank')"
                            style="cursor: pointer">
                            <td>Tinplate badge</td>
                            <td>US$8.99</td>
                        </tr>

                        <tr class="tr-type1"
                            onclick="window.open('https://genshin.global/product/genshin-concert-2022-commemorative-ticket/', '_blank')"
                            style="cursor: pointer">
                            <td>Commemorative hologram ticket</td>
                            <td>US$6.99</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div id="extras" class="content-extras">
                <div class="content-section text-white">
                    <h2 class="section-heading">EXTRAS</h2>
                    <p class="section-subheading">Where Adventures Meet Imagination!</p>

                    <article class="fanartmother">
                        <a href="https://genshin.global/category/fan-art/" rel="category tag">Fan Art</a>
                        <h1>Genshin Impact cosplay</h1>
                        <div>
                            <ul class="" style="list-style-type: none">
                                <li class="modified-date">
                                    <time class="updated" datetime="2022-10-19T23:49:38+08:00"></time>
                                </li>
                                <li class="meta-author">
                                    <p>
                                        Posted by
                                        <a href="https://genshin.global/author/man-2-2/" rel="author">
                                            <span class="">Dear Travelers</span>
                                        </a>
                                    </p>
                                </li>
                            </ul>
                        ...
                        <article class="fanartchild">
                            <p>
                                Recently, I have been seeing quite a lot of Genshin Impact 2nd
                                anniversary paintings in different styles. And this artist’s
                                illustration has attracted me deeply. Her art piece included
                                my favorite characters, as well as the adorable Slime. The
                                whole painting reminded me of the first time I played the
                                game, the story about
                                <a href="https://genshin.global/character/traveler-aether-lumine/">Lumine</a>
                                and
                                <a href="https://genshin.global/character/traveler-aether-lumine/">Aether</a>
                                at the beginning and the memories of the first encounter with
                                <a href="https://genshin.global/paimon/">Paimon</a>. Let’s
                        ...
                        <article class="fanartchild">
                            <p>
                                <strong>Tenyo: </strong>I left the company a year ago and have
                        ...
                        <article class="fanartchild">
                            <p>
                                <strong>Q. </strong>How long have you played Genshin Impact?
                                What propelled / motivated you to become an illustrator of
                                Genshin Impact?
                            </p>
                            <p>
                                <strong>Tenyo: </strong>I’m a traveler who joined from the
                                middle, so it’s only been a year since I started. The designs
                                of all Genshin characters are excellent. I drew for research
                                at first and it became more and more fun, so I have been
                                drawing the works of Genshin since then.
                            </p>
                            <p>
                                <strong>Q. </strong>Tell me about your favorite character of
                            ...
                            <p>
                                <strong>Tenyo: </strong>I’m completely in love at first sight,
                                with hair and purple eyes, which is exactly my taste’s still
                                regret not being able to get it because I couldn’t charge for
                                the pickup.
                            </p>
                        </article>
                        <article class="fanartchild">
                            <p>
                                <strong>Q. </strong>What’s your favorite region and/or
                                location in Genshin Impact and why.
                            </p>
                            <p>
                                <strong>Tenyo: </strong>I like the lightning bolts in the
                                country
                            </p>
                            <figure>
                                <img src="/Genshin_Concert_Band/assets/img/Fan-Art/4.jpg" alt="" class="thumbnail" />
                                <figurecaption></figurecaption>
                            </figure>
                        </article>
                        <article class="fanartchild">
                            <p>
                                <strong>Q. </strong>From start to finish, how long does it
                                take for you to create your work?
                            </p>
                            <p></p>
                            <p>
                                <strong>Tenyo: </strong>Depending on the content, a simple
                                sketch can be completed in an hour. If the background consists
                                of large numbers of character, it can take up to two weeks.
                            </p>
                            <figure>
                                <img src="/Genshin_Concert_Band/assets/img/Fan-Art/3.jpg" alt="" class="thumbnail" />
                                <figurecaption></figurecaption>
                            </figure>
                        </article>
                        <article class="fanartchild">
                            <p>
                                <strong>Q. </strong>Describe and share the best piece of
                                Genshin Impact art you’ve created.
                            </p>
                            <p></p>
                            <p>
                                <strong>Tenyo: </strong>This is a fine day, the number of
                                likes and retweets is the largest, and thanks to this work,
                                more people have recognized tithe trigger was to draw
                                Ritsuki’s capsule figure 6 times, and 3 came, which must be a
                                message. I drew it with a pen, without knowing that it would
                                grow so much.
                            </p>
                            <figure>
                                <img src="/Genshin_Concert_Band/assets/img/Fan-Art/6.jpg" alt="" class="thumbnail" />
                                <figurecaption></figurecaption>
                            </figure>
                        </article>
                        <article class="fanartchild">
                            <p>
                                <strong>Q. </strong>How do you define success as an
                                illustrator?
                            </p>
                            <p></p>
                            <p>
                                <strong>Tenyo: </strong>Do you think each person is
                                successful? For me, success is to make money and live with
                                illustrations for the rest of my life.
                            </p>
                            <figure>
                        ...
                        <article class="fanartchild">
                            <p>
                                <strong>Q. </strong>Name one of your favourite artists /
                                illustrators.
                            </p>
                            <p></p>
                            <p>
                                <strong>Tenyo: </strong>The illustrator “Rella” has a strong
                                presence of light, and it was a shock to me that there are so
                                many ways to express light.
                            </p>
                            <figure>
                                <img src="" alt="" class="thumbnail" />
                                <figurecaption></figurecaption>
                        ...
                        <article class="fanartchild">
                            <p>Some more drawings by Koki</p>
                            <p>
                                We thank her so much for the sharing with us.<br />Please
                                visit the talented artist’s profile and portfolio on different
                                social platforms. Don’t forget to like/follow to show your
                                support!
                            </p>
                            <figure>
                                <img src="" alt="" class="thumbnail" />
                    ...
                    <article class="cosplaymother">
                        <a href="" rel="category tag">Cosplay</a>
                        <h1>Genshin Impact Cosplay</h1>
                        <div>
                            <ul class="" style="list-style-type: none">
                                <li class="modified-date">
                        ...
                        <article class="cosplay">
                            ...
                            <article class="cosplaychild">
                                <p></p>
                                <figure>
                                    <img src="/Genshin_Concert_Band/assets/img/Cosplay/yunjn.png" alt="Junjin"
                                        class="thumbnail">
                                    <figurecaption></figurecaption>
                                </figure>
                            </article>
                            <article class="cosplaychild"></article>
                            <p></p>
                            <figure>
                                <img src="/Genshin_Concert_Band/assets/img/Cosplay/barbara.png" alt=""
                                    class="thumbnail" />
                                <figurecaption></figurecaption>
                            </figure>
                        </article>
                        <article class="cosplaychild">
                            <p></p>
                            <figure>
                                <img src="/Genshin_Concert_Band/assets/img/Cosplay/xinyan.png" alt=""
                                    class="thumbnail" />
                                <figurecaption></figurecaption>
                            </figure>
                        </article>
            ...
            <div id="media" class="content-media">
                <div class="content-section ">
                    <h2 class="section-heading">MEDIA</h2>
                    <p class="section-subheading">Dive into the Melodies of Teyvat: Where Every Note Tells a Story!</p>
                    <div class="music">
                        <iframe width="560" height="315"
                            src="https://www.youtube.com/embed/UIam8zl4af8?si=_HKo8jwFrNBfw4_z"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        <iframe width="560" height="315"
                            src="https://www.youtube.com/embed/LrqsaO9Cf2M?si=TMJipNyWwKe_TFyu"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        <iframe width="560" height="315"
                            src="https://www.youtube.com/embed/SC57e3VB_ZQ?si=pC7x2_1ngiQhthdk"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                ...
                <div class="footer-section">
                    <div class="content-section">
                        <div class="footer-logo">
                            <a href="https://genshin.hoyoverse.com/en/" target="_blank" rel="noopener noreferrer">
                                <img class="footer-logo1"
                                    src="https://fastcdn.hoyoverse.com/mi18n/resource-trans/upload/event/2023/07/10/5adaf3c356e577f0659899a8f5a2a06a_863358723360619202.png" />
                            </a>
                            <div class="footer-link">
                                <a href="https://genshin.hoyoverse.com/en/company/privacy" target="_blank"
                                    rel="noopener noreferrer">Privacy Policy</a>
                                <a href="https://genshin.hoyoverse.com/en/company/terms" target="_blank"
                                    rel="noopener noreferrer">Terms of Service</a>
                                <a href="https://www.hoyoverse.com/about-us?utm_source=genshin&amp;utm_medium=footer"
                                    target="_blank" rel="noopener noreferrer">About Us</a>
                                <a href="mailto:genshin_cs@hoyoverse.com" target="_blank"
                                    rel="noopener noreferrer">Contact
                                    Us</a>
                                <a href="https://cs.hoyoverse.com/static/hoyoverse-new-csc-service-hall-fe/index.html?page_id=19&amp;login_type=visitor&amp;game_biz=platform_hyvpass&amp;lang=en-us&amp;utm_source=genshin&amp;utm_medium=footer"
                            ...
                            <img class="footer-logo2"
                                ...
                                href="" style="width: 200px; border: none; vertical-align: middle" />

                            <p class="footer-comment">
                                "PlayStation Family Mark," "PS5 logo" and "PS4 logo" are
        ...
        <div class="model js-model">
            <div class="model-container js-model-container">
                ...
                <header class="model-header">
                    <img class="model-header-icon" src="/Genshin_Concert_Band/assets/img/Paimon.png" alt="" />
                    <i class="ti-bag">Tickets</i>
                </header>
                <div class="model-body">
                    <form action="index.php" method="POST">
                        <label id="ticket-form" for="ticket-quantity" class="model-label">
                            <i class="ti-shopping-cart"></i>
                            Tickets, $2 per person
                        </label>

                        <input required id="ticket-quantity" name="ticket-quantity" type="number" class="model-input"
                            placeholder="How many?" />
                        <!----------------------------------------------------->
                        <label id="ticket-form" for="ticket-name" class="model-label">
                            <i class="ti-user"></i>
                            Send to
                        </label>
                        <input required id="ticket-email" name="ticket-email" type="email" class="model-input"
                            placeholder="Enter your email..." />

                        <button id="buy-tickets" name="buy-tickets" type="submit">
                            Pay
                            <i class="ti-check"></i>
                        </button>
                        <footer class="model-footer">
                            <p class="model-help">
                                Need
                                <a href="model-help-child" href="https://www.paypal.com/us/cshelp/personal"
        ...
        if (isset($_COMMENT['contact-email']) && isset($_POST['ticket-quantity'])) {
            $recipient = $_POST['contact-email'];
            $number = $_POST['ticket-quantity'];

            if (empty($recipient) || empty($number)) {
        ?>
        <div class="alert">
            <?php echo "Please fill in this!" ?>
        </div>
        <?php
            } else {
                ...
                try {
                    ...
                    $mail->SMTPAuth = true;
                    $mail->Username = 'duyet.cao1203@hcmut.edu.vn';
                    $mail->Password = 'qnzl mjfj efrw vprv';
                    ...
                    $mail->From = 'duyet.cao1203@hcmut.edu.vn';
                    $mail->addAddress($recipient);

                    $mail->isHTML(true);
                    $mail->Subject = 'Ticket Purchase Confirmation';
                    $mail->addEmbeddedImage($_SERVER['DOCUMENT_ROOT'] . '/Genshin_Concert_Band/assets/img/Paimon.png', 'brandLogo', 'Paimon.png');
                    $mail->Body = "<h2 style='color: black;'> Congratulations!<br>"
                        . "Thank you for your purchase. Please transfer the payment to the following account:<br><br></h2>"
                        . "<p style='color: blue;'>Account Number: 1234 5678 9876 5432<br>"
                        . "Account Name: <a href='https://xemphim.blog/phim/heo-peppa-phan-2/' style='color: blue;'>DUYET DEP ZAI</a><br>"
                        . "Bank Name: Vietcombank <br></p>"
                        . "<p style='color: red;'><strong>Total Ticket Cost: $" . (2 * $number) . " for " . $number . " ticket(s) </strong></p><br>"
                        . "If you have any questions, please access this form: <a href='https://xemphim.blog/phim/heo-peppa-phan-2/' style='color: blue;'> /https:form/for/any/questions/google.com </a>"
                        . "<h2 style='color: black;'>We appreciate your attendance!<br><br><br></h2>"
                        . "<img src='cid:brandLogo' alt='Brand Logo' style='max-width: 100%; height: auto;'>";
        ...
        <?php
                ...
                ?>
        <div class="alert">
            <?php echo "Failed Booking. Mailer Error: {$mail->ErrorInfo}" ?>
        </div>
        <?php
                }
            }
        ...
        if (isset($_COMMENT['buy-tickets']) && isset($_COMMENT['ticket-quantity'])) {
            $recipient = $_COMMENT['ticket-email'];
            $number = $_COMMENT['ticket-quantity'];
        ...
        <!-- Overlay cho hình ảnh full-size -->
        <div id="imageOverlay" class="overlay">
            <img class="overlay-content" id="fullImage" />
            <i class="ti-close imgclose"></i>
        </div>
        ...
        document
            ...
            .addEventListener("submit", function(event) {
                ...
                // Gửi dữ liệu form sử dụng fetch API
                fetch("index.php", {
                        method: "POST",
                        body: formData,
                    })
        ...
        <!--BUY-->
        <script>
        const buyBtns = document.querySelectorAll(".place-buy-button");
        ...
        document.addEventListener("DOMContentLoaded", () => {
            const images = document.querySelectorAll(
                ".member-avatar"); // Lấy tất cả các phần tử có lớp 'member-avatar'

            // Duyệt qua từng phần tử ảnh
            for (const image of images) {
                image.addEventListener("click", () => {
                    // Thêm lớp 'clicked' khi nhấp
                    image.classList.add("clicked");

                    // Xóa lớp 'clicked' sau 200ms để ảnh trở về kích thước ban đầu
                    setTimeout(() => {
        ...
        var closeBtn = document.querySelector(".imgclose");

        // Khi click vào thumbnail
        thumbnails.forEach(function(thumbnail) {
            thumbnail.addEventListener("click", function() {
                fullImage.src = this.src; // Lấy src của hình thumbnail và đặt cho overlay
